...
The title screen include an option to change the difficulty from 0 to 9. These simply add a number of randomly placed obstacles at 10x the difficulty selected.
